<template>
    <div class="max-w-2xl space-y-6">
        <div class="flex items-center justify-between">
            <h1 class="text-xl font-semibold text-slate-800 uppercase">Registrar Edificio</h1>
...
const form = reactive({
    campusId:    route.query.campusId ? Number(route.query.campusId) : null as number | null,
    name:        '',
    shortName:   '',
    description: '',
    status:      true,
...
async function submit() {
    ...
    try {
        await api.post(API.SCHOOL_SERVICES_API.buildings.create, {
