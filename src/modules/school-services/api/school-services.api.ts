...
export default {
    ...
    api: {
        ...
        mobility: {
            ...
            revisions:   (id: string | number) => apiUrl(`/school-services/mobility/cases/${id}/revisions`),
            documentStatus:  (id: string | number) => apiUrl(`/school-services/mobility/cases/${id}/document-status`),
            archiveDocument: (id: string | number) => apiUrl(`/school-services/mobility/cases/${id}/archive-document`),
