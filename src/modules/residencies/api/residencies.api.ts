...
const residenciesApi: ApiModule = {
    ...
    api: {
        ...
        residency: {
            ...
            grantException:         (id: string | number) => apiUrl(`/residencies/residencies/${id}/process-exception`),
            revokeException:        (id: string | number) => apiUrl(`/residencies/residencies/${id}/process-exception`),
        ...
        documents: {
            ...
            storeGenerated:  (id: string | number) => apiUrl(`/residencies/residencies/${id}/documents/generated`),
