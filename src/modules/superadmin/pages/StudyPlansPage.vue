...
const columns: DataTableColumn<StudyPlanType>[] = [
    ...
    { key: 'periodType', label: 'TIPO DE PERIODO' },
...
function create() {
    router.push({ name: 'superadmin.studyplans.create' })
}

function show(row: StudyPlanType) {
    console.log("show", row)
    router.push({ name: 'superadmin.studyplans.show', params: { id: row.id } })
}

function edit(row: StudyPlanType) {
    console.log("edit", row)
    router.push({ name: 'superadmin.studyplans.edit', params: { id: row.id } })
}
