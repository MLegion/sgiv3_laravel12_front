<template>
    <div class="max-w-2xl space-y-6">
        <div class="flex items-center justify-between">
            <h1 class="text-xl font-semibold text-slate-800">DETALLE - DOCUMENTO REQUERIDO</h1>
        ...
        <div class="bg-white border rounded-xl shadow-sm p-6 space-y-8">
            ...
            <section>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <InfoItem label="OFERTA ACADÉMICA" :value="doc.academicOffer ? `ID: ${doc.academicOffer.id}` : null" :loading="loading" />
...
const doc = ref<OfferRequiredDocument>({} as OfferRequiredDocument)
