<template>
    <div class="max-w-xl space-y-6">
        <div class="flex items-center justify-between">
            <h1 class="text-xl font-semibold text-slate-800">EDITAR DOCUMENTO REQUERIDO GLOBAL</h1>
...
async function submit() {
    ...
    try {
        await api.put(API.ADMISSIONS_API.globalRequiredDocuments.update(route.params.id as string), form.value)
        router.push({ name: 'admissions.global-required-documents.show', params: { id: route.params.id } })
    } catch (e: any) {
