                ...
                <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <div class="sm:col-span-2 flex items-center gap-2">
                            <input v-model="cForm.is_emergency_contact" type="checkbox" id="portal_tab_emergency" class="rounded" />
                            <label for="portal_tab_emergency" class="text-xs text-slate-600">Contacto de emergencia</label>
                        </div>
                    </div>
